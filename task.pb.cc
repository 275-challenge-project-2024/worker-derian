...
PROTOBUF_CONSTEXPR Task::Task(
  ...
  , /*decltype(_impl_.curr_capacity_)*/0
...
static ::_pb::Metadata file_level_metadata_task_2eproto[3];
...
const uint32_t TableStruct_task_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::worker::Task, _impl_.curr_capacity_),
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 11, -1, -1, sizeof(::worker::TaskStatus)},
  { 19, -1, -1, sizeof(::worker::HeartBeatRequest)},
};
...
Task::Task(const Task& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.curr_capacity_){}
    , /*decltype(_impl_._cached_size_)*/{}};
  ...
  ::memcpy(&_impl_.taskid_, &from._impl_.taskid_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.curr_capacity_) -
    reinterpret_cast<char*>(&_impl_.taskid_)) + sizeof(_impl_.curr_capacity_));
...
// @@protoc_insertion_point(message_clear_start:worker.Task)
  ...
  ::memset(&_impl_.taskid_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.curr_capacity_) -
      reinterpret_cast<char*>(&_impl_.taskid_)) + sizeof(_impl_.curr_capacity_));
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          _impl_.curr_capacity_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Task::_InternalSerialize(
  ...
  // int32 curr_capacity = 5;
  if (this->_internal_curr_capacity() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(5, this->_internal_curr_capacity(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:worker.Task)
  ...
  // int32 curr_capacity = 5;
  if (this->_internal_curr_capacity() != 0) {
    total_size += ::_pbi::WireFormatLite::Int32SizePlusOne(this->_internal_curr_capacity());
  }
...
void Task::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_curr_capacity() != 0) {
    _this->_internal_set_curr_capacity(from._internal_curr_capacity());
  }
...
void Task::InternalSwap(Task* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Task, _impl_.curr_capacity_)
      + sizeof(Task::_impl_.curr_capacity_)
